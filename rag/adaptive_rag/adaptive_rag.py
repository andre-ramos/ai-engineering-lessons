...
# Define the Factual Retrieval Strategy class
class FactualRetrievalStrategy(BaseRetrievalStrategy):
    # return the 4 most relevant documents by default, but can be changed by the user
    def retrieve(self, query, k=4):
        ...
        # Retrieve documents using the enhanced query, retrive k*2 documents to have more options for ranking
...
# Define the Analytical Retrieval Strategy class
...
class PydanticAdaptiveRetriever(BaseRetriever):
    ...
    def _get_relevant_documents(self, query: str) -> List[Document]:
        return self.adaptive_retriever._get_relevant_documents(query)
